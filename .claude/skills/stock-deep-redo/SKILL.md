...
| 2026-08-17→20 | 光智科技（A 股单市场、**首建档**、**控制者前提被三路全盘推翻**、**会话跨 3 天中断**）| 三路**+深度上限+三轮跨路校准（全部推给 A1）** | **0 返修（SPEC-COMPLIANT / APPROVED-WITH-NITS，2 Minor 控制者自修）** | **净作业约 53.5min**（墙钟 147min 含 98min 中断空档）|
...
- **派发时按 40-60min 预估**（多业务线 / 多 lens 命中 / A+H / 二值缺口 / 撞财报日 / 多轮返修往上取），
  **别按理论值许诺**——spec 原定的 29min 十二轮实测无一达到，**十二轮中位数 56.6min、区间 32.3-86min**
