...
from app.routes import main, position, advice, category, trade, stock, daily_record, profit, rebalance, heavy_metals, briefing, stock_detail, watch, news, value_dip, earnings_page, supply_chain, valuations, minerals
