...
SUPPLY_CHAIN_GRAPHS = {
    ...
    '3d_printing': {
        'name': '3D 打印（增材制造）产业链',
        'code': '3DPRINT',
        'description': 'A 股 + 港股增材制造全链。核心判断「产业赢、股东未必赢」：中国厂商拿下全球消费级 '
                       '90%+ 出货份额（2026 前 4 月出口 246 万台 / +44.7%），但份额靠价格战换来，'
                       '利润集中在未上市的拓竹（净利率约 30%）；唯一上市的消费级标的创想三维 2026H1 增收不增利。'
                       '工业金属侧铂力特/华曙高科基本面真在加速（华曙 26H1 营收 +42.27%），但估值把三年增长吃完'
                       '（华曙 PE 643x / PB 21.9x）。链上真正「纯度高」的只有 3 家，其余「卖铲人」3D 打印敞口'
                       '被稀释到不构成投资理由。详见 docs/stock-analytics/themes/2026-09-02-A股港股3D打印产业链梳理.md',
        'core': {
            'technologies': ['SLM 激光选区熔化', 'EBM 电子束熔化', 'FDM 熔融沉积', '光固化 SLA/LCD',
                             'SLS 选择性激光烧结', '冷喷涂增材修复'],
            'products': ['工业金属打印机', '工业高分子打印机', '消费级打印机', '金属粉末/耗材',
                         '打印服务与定制件', '3D 扫描仪（逆向入口）'],
            'customers': ['航空航天/军工院所', '骨科植入器械厂', '手机与折叠屏整机厂',
                          '汽车与模具厂', '个人创客/教育/海外电商'],
        },
        'extra_cores': [
            {
                ...
                'name': '铂力特',
                'market': 'A',
                'description': '工业金属增材龙头，航空航天主战场 + 自供钛粉 10 条线；质地全链最硬、价格已透支',
            },
            {
                'code': '688433',
                'name': '华曙高科',
                'market': 'A',
                'description': '金属 + 高分子双线整机，增速全链最快（26H1 营收 +42.27%）；PE 643x 估值最离谱',
            },
            {
                'code': '03388',
                'name': '创想三维',
                'market': 'HK',
                'description': '2026-05-29 上市，港股唯一 3D 打印纯标的；全球消费级打印机份额第二 11.2%、'
                               '消费级 3D 扫描仪第一 45.3%，但 26H1 增收不增利',
            },
        ],
        'upstream': {
            '金属粉末': {
                'description': '钛合金/高温合金/铁基球形粉，增材专用粉产能普遍很小，多数厂主业不在此',
                'companies': {
                    '688456': {'name': '有研粉材', 'role': '增材粉体设计产能仅 500 吨/年；主业是国内第一的锡基焊粉（份额 15%+），3D 是期权', 'tag': 'not_analyzed'},
                    '688786': {'name': '悦安新材', 'role': '羰基铁粉，小市值，增材敞口需财报核实', 'tag': 'not_analyzed'},
                    '000969': {'name': '安泰科技', 'role': '粉末冶金/难熔材料，增材非主业', 'tag': 'not_analyzed'},
                    '300034': {'name': '钢研高纳', 'role': '高温合金，主业铸锻件而非增材粉', 'tag': 'not_analyzed'},
                },
            },
            '钛材基材': {
                'description': '钛合金棒材/板材，苹果折叠机钛合金渗透的 read-across 落点',
                'companies': {
                    '688122': {'name': '西部超导', 'role': '钛合金棒材 + 超导线材，主驱动是航空钛材非 AM', 'tag': 'not_analyzed'},
                    '002149': {'name': '西部材料', 'role': '钛/特种材料；池内已评 exclude「主题外」，不因钛合金 AM 概念翻案', 'tag': 'don_buy'},
                    '00826': {'name': '天工国际', 'role': '钛合金/模具钢/高速钢（港股）。PB 0.91x 破净、PE 17.4x，全链最便宜的上游，但需验证是否价值陷阱', 'tag': 'keep_watching'},
                },
            },
            '高分子耗材': {
                'description': 'PLA/光敏树脂/改性塑料，消费级打印机的「刀片」端，创想三维耗材收入 26H1 +48.3%',
                'companies': {
                    '688203': {'name': '海正生材', 'role': 'PLA 耗材；主驱动是可降解塑料政策不是 3D', 'tag': 'don_buy'},
                    '300221': {'name': '银禧科技', 'role': '改性塑料，3D 打印概念大于实质', 'tag': 'don_buy'},
                    '301193': {'name': '家联科技', 'role': '生物基材料，3D 是边角业务', 'tag': 'don_buy'},
                },
            },
            '光路与控制': {
                'description': '激光器/振镜/控制系统，理论上是卖铲人，实际 AM 需求占比极低',
                'companies': {
                    '300747': {'name': '锐科激光', 'role': '光纤激光器，主需求是切割焊接不是增材', 'tag': 'not_analyzed'},
                    '688167': {'name': '炬光科技', 'role': '激光元器件；池内已评 exclude「CPO 题材股、安全边际为负」', 'tag': 'don_buy'},
                    '688291': {'name': '金橙子', 'role': '振镜控制系统；公司自认 3D 打印相关产品「占比较低」', 'tag': 'don_buy'},
                },
            },
        },
        'midstream': {
            '工业金属整机（SLM/EBM）': {
                'description': '本链纯度最高环节，航空航天壁垒真实，问题纯粹在价格',
                'companies': {
                    '688333': {'name': '铂力特', 'role': '同 extra_cores。2025 营收 18.52 亿/+39.69%、归母 2.04 亿/+95.14%；现价对 2026E 归母隐含约 103x，高于卖方自己给的 85x 口径', 'tag': 'keep_watching'},
                    '688433': {'name': '华曙高科', 'role': '同 extra_cores。26H1 归母 843 万对应 469 亿市值', 'tag': 'keep_watching'},
                    '874878': {'name': '赛隆股份', 'role': '电子束粉末床熔融（新三板，流动性差）', 'tag': 'not_analyzed'},
                },
            },
            '消费级整机（FDM/光固化）': {
                'description': '中国厂商全球份额 90%+，但利润在未上市的拓竹手里；上市可选集只有创想三维一个',
                'companies': {
                    '03388': {'name': '创想三维', 'role': '同 extra_cores。26H1 营收 16.26 亿/+12.9%，预亏 5300-6300 万，TTM 净亏 4.03 亿港元；耗材 +48.3% 是唯一亮点', 'tag': 'keep_watching'},
                },
            },
            '激光设备平台（含 3D 产品线但敞口低）': {
                'description': '高频出现在「3D 打印概念股」名单，实际营收由 PCB 设备/光模块/汽车激光主导',
                'companies': {
                    '002008': {'name': '大族激光', 'role': '池内已建档 watch：thesis 是「大族数控看涨凭证 + 母体主业隐含零估值」，与本链无关', 'tag': 'keep_watching'},
                    '000988': {'name': '华工科技', 'role': '买它等于买光模块 + 汽车激光，3D 打印只是标签', 'tag': 'don_buy'},
                },
            },
            '3D 扫描（逆向工程入口，邻接非本体）': {
                'description': '与创想三维扫描仪业务正面竞争',
                'companies': {
                    '688583': {'name': '思看科技', 'role': '工业级 3D 扫描，PE 182x', 'tag': 'not_analyzed'},
                },
            },
        },
        'downstream': {
            '航空航天 / 军工': {
                'description': '铂力特主战场，增材真正跑通经济性的第一个场景',
                'companies': {
                    '688237': {'name': '超卓航科', 'role': '航空冷喷涂增材修复，PE 311x、盈利基数极小', 'tag': 'not_analyzed'},
                    '300004': {'name': '南风股份', 'role': '重型金属 3D 打印，PE 2.4 万倍即利润近零', 'tag': 'don_buy'},
                },
            },
            '医疗骨科（全链唯一便宜且已盈利）': {
                'description': '估值最低的一组，但重估驱动是骨科集采出清 + 手术量恢复，不是 3D 打印本身',
                'companies': {
                    '01789': {'name': '爱康医疗', 'role': 'iCOS 数字骨科定制方案，PE 13.06x / PB 1.74x，2025 收入 14.82 亿/+10.1%（港股）', 'tag': 'keep_watching'},
                    '01858': {'name': '春立医疗', 'role': '骨科植入器械（港股），与爱康同赛道', 'tag': 'not_analyzed'},
                    '688161': {'name': '威高骨科', 'role': 'PE 33x / PB 2.1x，集采出清逻辑', 'tag': 'not_analyzed'},
                    '002901': {'name': '大博医疗', 'role': 'PE 24x，3D 敞口中低', 'tag': 'not_analyzed'},
                    '301033': {'name': '迈普医学', 'role': '颅颌面植入/硬脑膜，少数已盈利且不贵的下游', 'tag': 'not_analyzed'},
                },
            },
            '消费电子结构件': {
                'description': '钛合金 3D 打印进手机中框/铰链是唯一穿透到本 docs 池的传导链；'
                               '但无任何上市公司确认量产订单（铂力特称保密、有研粉材称未收到通知），属渗透率叙事',
                'companies': {
                    '300115': {'name': '长盈精密', 'role': '荣耀链钛合金结构件，敞口未公开量化', 'tag': 'not_analyzed'},
                    '002600': {'name': '领益智造', 'role': '池内已建档 watch：AM 对精密功能件同时是工艺替代威胁与 ASP 上移期权', 'tag': 'keep_watching'},
                    '688210': {'name': '统联精密', 'role': 'MIM 精密件，3D 打印是其替代威胁而非利好', 'tag': 'not_analyzed'},
                    '300709': {'name': '精研科技', 'role': 'MIM 精密件，同上', 'tag': 'not_analyzed'},
                    '600114': {'name': '东睦股份', 'role': '粉末冶金/MIM，既竞争又供材料', 'tag': 'not_analyzed'},
                    '00285': {'name': '比亚迪电子', 'role': '消费电子结构件代工（港股），同逻辑', 'tag': 'not_analyzed'},
                },
            },
            '模具 / 铸造砂型': {
                'description': '砂型 3D 打印替代传统木模，国内渗透早但玩家盈利普遍很差',
                'companies': {
                    '300521': {'name': '爱司凯', 'role': '3D 砂型打印，亏损 + PB 7.4x', 'tag': 'don_buy'},
                    '300337': {'name': '银邦股份', 'role': '金属复合材料/砂型，敞口稀薄', 'tag': 'don_buy'},
                },
            },
            '打印服务 / 代工': {
                'description': '重资产、无规模效应，是本链商业模式最差的环节',
                'companies': {
                    '300227': {'name': '光韵达', 'role': '3D 打印服务，亏损', 'tag': 'don_buy'},
                },
            },
        },
        'competitors': {
            '688333': {'name': '铂力特', 'market': 'A'},
            '688433': {'name': '华曙高科', 'market': 'A'},
            '03388': {'name': '创想三维', 'market': 'HK'},
        },
        'trends': {
            'bandwidth': '消费级从 FDM 单色向多色/高速/AI 建模演进，工业级从「打样」走向「批量结构件」；'
                         '2026 苹果首款折叠 iPhone 量产被视为钛合金 3D 打印从形象工程走向结构标配的节点',
            'technologies': ['多激光器铺粉（提效降本）', 'AI 建模 + 机器视觉自动纠错',
                             '耗材/刀片模型（创想三维耗材 26H1 +48.3%）', '钛合金消费电子结构件',
                             '人形机器人轻量化结构件（尚属叙事）'],
            'china_role': '中国厂商 2025 年占全球消费级出货 90%+、2026Q1 工业级国内出货 +29%，产业地位无争议；'
                          '但份额靠价格战换取，利润集中在未上市的拓竹。可投标的的纯度与估值呈反向：'
                          '纯度最高的三家（铂力特/华曙高科/创想三维）估值最贵或仍在亏损，'
                          '便宜的（天工国际 PB 0.91x、爱康医疗 PE 13x）3D 打印又不是其主要驱动力',
        },
    },
}
